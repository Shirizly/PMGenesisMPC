...
NCA_HIDDEN = 16       # hidden channels inside each NCA conv block
NCA_STEPS = 4         # number of iterative local update steps
UNET_FEATURES = [8, 16]  # correction UNet encoder channel widths
