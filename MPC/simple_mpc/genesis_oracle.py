...
# The simulator plus MPC-side incremental transition recording
# (push_and_record / flush_transitions / set_transition_context /
# broadcast_state_from_env). Those live in a subclass rather than in
# Genesis/sandbox_manipulation.py - see MPC/env/recording_sandbox.py.
from env.recording_sandbox import RecordingSandbox as SandboxManipulation
